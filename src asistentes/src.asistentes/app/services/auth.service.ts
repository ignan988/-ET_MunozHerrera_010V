...
export class AuthService {
  ...
  getAllEventosGlobales(): Observable<any[]> {
    return this.httpclient.get<any[]>(`${environment.apiUrl}/eventosGlobales`);
  }
  
  // Agregar un nuevo evento global
...
// Editar un evento global existente
